...
const SetupsContainer = memo(
  ({ hasNewCard, viewMode }: { hasNewCard?: boolean; viewMode: string }) => {
    ...
    const { data: setups, isFetching, refetch } = useGetSetupsQuery({ viewMode });
    ...
    return (
      <Box sx={{ height: "100%", overflowY: "auto", px: 4, py: 2 }}>
        <Backdrop
          ...
          open={isFetching || isDeleting || isActivating }
        >
